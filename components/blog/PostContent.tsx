  ...
  return (
    <article className="max-w-3xl mx-auto px-4 sm:px-6 py-10">
      ...
      <header className="mb-6">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold leading-tight text-gray-900 dark:text-white">
          {title}
        </h1>
        ...
        <div className="mt-4 flex items-center gap-2">
          ...
          <button
            type="button"
            onClick={copyLink}
            className="inline-flex items-center gap-2 px-3 py-1.5 border border-gray-200 dark:border-gray-700 text-sm rounded hover:bg-gray-50 dark:hover:bg-gray-800"
          >
            Copy link
          </button>
        </div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <p className="text-sm text-gray-600 dark:text-gray-300">
              Enjoyed this? Subscribe for more practical guides.
            </p>
          </div>
          <div>
            <Link
